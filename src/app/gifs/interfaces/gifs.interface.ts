// To parse this data:
//
//   import { Convert, DataGifsApp } from "./file";
//
//   const dataGifsApp = Convert.toDataGifsApp(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface DataGifsApp {
    data:       dataGifs[];
...
export class Convert {
    public static toDataGifsApp(json: string): DataGifsApp {
        return cast(JSON.parse(json), r("DataGifsApp"));
    }

    public static dataGifsAppToJson(value: DataGifsApp): string {
        return JSON.stringify(uncast(value, r("DataGifsApp")), null, 2);
    }
}
